...
├── jarvis.py      ← Voice I/O, wake word, Groq AI
├── actions.py     ← All action handlers
├── utils.py       ← Email, WhatsApp, screen vision (shared helpers)
├── gui.py         ← PyQt5 dashboard
├── memory.py      ← SQLite persistence
├── config.py      ← API keys, app paths, contacts
...
- Threading TTS with PyQt5 GUI was tricky — had to use signal bridges + a TTS queue
